...
function preload (){
    ...
    this.load.spritesheet('julian-w', 'assets/img/julian-walk.png',
        { frameWidth: 30, frameHeight: 46, margin: 2, spacing: 19,}
    );
    /* Personaje: Luna */
...
function create (){
    ...
    player = this.physics.add.sprite(100, 400, 'jaz-w').setScale(3);
    player.setBounce(0.2); /* rebote */
    player.setCollideWorldBounds(true); /* respeta los límites de pantalla */

    this.anims.create({
        key: 'left',
        frames: this.anims.generateFrameNumbers('jaz-w', { start: 0, end: 5 }),
        frameRate: 10,
        repeat: -1,
    });
    ...
    this.anims.create({
        key: 'turn',
        frames: this.anims.generateFrameNumbers('jaz', { start: 0, end: 3 }),
        //frames: [ { key: 'jaz', frame: 1 } ],
        frameRate: 10,
        repeat: -1,
    });
    ...
    this.anims.create({
        key: 'right',
        frames: this.anims.generateFrameNumbers('jaz-w', { start: 0, end: 3 }),
        frameRate: 10,
        repeat: -1
    });
